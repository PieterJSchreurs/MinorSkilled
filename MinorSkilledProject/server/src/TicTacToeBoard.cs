...
namespace server
{
    ...
    public class TicTacToeBoard
    {
        ...
        public bool isValidMove(int pMove, int pPlayer)
        {
            if (_playerTurn == pPlayer && _board.board[pMove] == 0)
            {
                return true;
            } else
            {
        ...
        //Add a way to see if the game is won.
        public bool HasWon()
        {
            if (_board.WhoHasWon() != 0)
            {
                return true;
            }
            else
